<?php  //[STAMP] ff1e9caef8be96604334d5edb84ac6c3
...
trait AcceptanceTesterActions
{
     ...
     *
     *
     * @see \Helper\Acceptance::screen()
     */
    public function screen() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('screen', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::cutFloatNumber()
     */
    public function cutFloatNumber($string) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('cutFloatNumber', func_get_args()));
    }
